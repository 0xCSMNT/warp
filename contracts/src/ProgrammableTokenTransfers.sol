...
contract ProgrammableTokenTransfers is CCIPReceiver, OwnerIsCreator {
    ...
    address public timeBasedKeeper;
    address public thresholdBasedKeeper;

    /// @notice Constructor initializes the contract with the router address.
    /// @param _router The address of the router contract.
    /// @param _link The address of the link contract.
    constructor(address _router, address _link) CCIPReceiver(_router) {
        s_router = IRouterClient(_router); // Assign the router address to the state variable.
        s_linkToken = IERC20(_link); // Assign the LINK token address to the state variable.
    }

    /// @dev function to add timeBasedKeeper
    function addTimeBasedKeeper(address _timeBasedKeeper) external onlyOwner {
    ...
    function _buildCCIPTokenTransfer(
        //
        address _receiver,
        address _token,
        uint256 _amount,
